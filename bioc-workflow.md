...
`  `\
    ...
    ## Annotation:  
    ## - - - Processing information - - -
    ## Combined [6725,20] and [6268,10] MSnSets Wed Nov 30 15:02:25 2016 
...
`  `\
    ...
    ## - - - Processing information - - -
    ## Combined [6725,20] and [6268,10] MSnSets Wed Nov 30 15:02:25 2016 
    ## Subset [6725,20][5032,20] Wed Nov 30 15:02:26 2016 
    ## Removed features with more than 0 NAs: Wed Nov 30 15:02:26 2016 
    ## Dropped featureData's levels Wed Nov 30 15:02:26 2016 
    ##  MSnbase version: 1.21.7
...
Adding user-defined marker lists {#adding-user-defined-marker-lists .unnumbered}
--------------------------------
...
In addition to adding annotation using the `addMarkers` function, one
can store specific sets of proteins by using the *Features of interest*
infrastructure from the package. If users have specific subsets of
proteins they wish to highlight in their data (possibly across multiple
experiments) they would first create a `FeaturesOfInterest` object. For
example, if we wanted to highlight a proteins with the accession numbers
Q8CG48, Q8CG47, Q8K2Z4, and Q8C156, which are some of the proteins known
to form part of the 13S condensin complex, we would create a first
create a `FeaturesOfInterest` object, and subsequently highlight their
location on a PCA plot with the `highlightOnPlot` function.
...
`                              `\
    ...
    ##  Created on Wed Nov 30 15:02:28 2016 
    ##  Description:
...
function. We see that 5 new phenotype data clusters were found.
    ...
    ## Annotation:  
    ## - - - Processing information - - -
    ## Added markers from  'mrk' marker vector. Wed Nov 30 15:02:27 2016 
    ## Added markers from  'pdres' marker vector. Wed Nov 30 15:02:28 2016 
    ##  MSnbase version: 2.1.4
...
`              `
    ...
    ##            40S Ribosome            60S Ribosome      Actin cytoskeleton 
    ##               0.4348219               0.3034081               0.3800417 
    ##                 Cytosol   Endoplasmic reticulum                Endosome 
    ##               0.6838374               0.5953475               0.4285470 
    ##    Extracellular matrix                Lysosome           Mitochondrion 
    ##               0.4261188               0.5933032               0.9494300 
    ##     Nucleus - Chromatin Nucleus - Non-chromatin              Peroxisome 
    ##               0.7951832               0.7086165               0.3130830 
