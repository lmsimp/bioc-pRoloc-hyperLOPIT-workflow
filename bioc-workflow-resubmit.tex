...
## Annotation:  
## - - - Processing information - - -
## Combined [6725,20] and [6268,10] MSnSets Tue Apr 17 15:40:33 2018 
...
## - - - Processing information - - -
## Combined [6725,20] and [6268,10] MSnSets Tue Apr 17 15:40:33 2018 
## Subset [6725,20][5032,20] Tue Apr 17 15:40:34 2018 
## Removed features with more than 0 NAs: Tue Apr 17 15:40:34 2018 
## Dropped featureData's levels Tue Apr 17 15:40:34 2018 
##  MSnbase version: 1.21.7
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##  Created on Tue Apr 17 15:40:38 2018 
##  Description:
...
## Annotation:  
## - - - Processing information - - -
## Added markers from  'mrk' marker vector. Tue Apr 17 15:40:37 2018 
## Added markers from  'pdres' marker vector. Tue Apr 17 15:40:39 2018 
##  MSnbase version: 2.4.2
\end{verbatim}
\begin{alltt}
...
\hlkwd{write.exprs}\hlstd{(hl,} \hlkwc{fcol} \hlstd{=} \hlstr{"pd"}\hlstd{,} \hlkwc{file} \hlstd{=} \hlstr{"pd-results.csv"}\hlstd{,} \hlkwc{sep} \hlstd{=} \hlstr{","}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{## set point size of each protein to be proportional to the svm score}
...
\begin{verbatim}
##            40S Ribosome            60S Ribosome      Actin cytoskeleton 
##               0.4382130               0.3040042               0.3797701 
##                 Cytosol   Endoplasmic reticulum                Endosome 
##               0.6897383               0.6007307               0.4284784 
##    Extracellular matrix                Lysosome           Mitochondrion 
##               0.4200181               0.5879109               0.9502066 
##     Nucleus - Chromatin Nucleus - Non-chromatin              Peroxisome 
##               0.7951514               0.7100151               0.3166095 
