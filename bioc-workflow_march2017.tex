...
profiles into \st{a}\hl{the} same intensity interval (typically 0 and 1) by, for
...
## Annotation:  
## - - - Processing information - - -
## Combined [5489,10] and [6268,10] MSnSets Wed Apr  4 13:30:04 2018 
## Subset [6725,20][5032,20] Wed Apr  4 13:30:17 2018 
## Removed features with more than 0 NAs: Wed Apr  4 13:30:17 2018 
## Dropped featureData's levels Wed Apr  4 13:30:17 2018 
## Subset [5032,20][5032,20] Wed Apr  4 13:33:06 2018 
## Removed features with more than 0 NAs: Wed Apr  4 13:33:06 2018 
## Dropped featureData's levels Wed Apr  4 13:33:06 2018 
## Subset [5032,20][5032,20] Wed Apr  4 13:42:10 2018 
## Removed features with more than 0 NAs: Wed Apr  4 13:42:10 2018 
## Dropped featureData's levels Wed Apr  4 13:42:10 2018 
## Subset [5032,20][5032,20] Wed Apr  4 13:45:12 2018 
## Removed features with more than 0 NAs: Wed Apr  4 13:45:12 2018 
## Dropped featureData's levels Wed Apr  4 13:45:12 2018 
...
## Removed features with more than 0 NAs: Wed Apr  4 13:45:12 2018 
## Dropped featureData's levels Wed Apr  4 13:45:12 2018 
## Subset [5032,20][5032,20] Wed Apr  4 13:47:14 2018 
## Removed features with more than 0 NAs: Wed Apr  4 13:47:14 2018 
## Dropped featureData's levels Wed Apr  4 13:47:14 2018 
##  MSnbase version: 2.5.9
\end{verbatim}
\end{kframe}
\end{knitrout}
...
gradient} \st{using the \texttt{plotDist} function}. \hl{While the PCA
...
\st{would create a first create a \texttt{FeaturesOfInterest} object, and
...
##  Created on Wed Apr  4 13:47:16 2018 
##  Description:
...
\st{Note: We do not evaluate this code chunk in this document as the
...
\texttt{?phenoDisco}) will heavily influence (increase) the total
time taken to run the algorithm.  \texttt{phenoDisco} supports
parallelisation and we strongly suggest you make use of a parallel
processing to run these analyses. 

\hl{Please note, in this document we can not evaluate the call to 
`phenoDisco` in the code chunk above as the algorithm is computationally 
intensive and best parallelised over multiple workers. This phenoDisco 
analysis took ~24 hours to complete when parallelised over 40 workers. 
The ouput of running the \texttt{phenoDisco} algorithm is an
\texttt{MSnSet} containing the new data clusters, appended to the
\texttt{featureData} under the name \texttt{pd}. We have made the results
readily available for users to interrogate and get an idea of the type
of output one may expect from using this function.} The results can be
...
## Annotation:  
## - - - Processing information - - -
## Added markers from  'mrk' marker vector. Wed Apr  4 13:47:15 2018 
## Added markers from  'pdres' marker vector. Wed Apr  4 13:47:17 2018 
##  MSnbase version: 2.5.10
\end{verbatim}
\begin{alltt}
...
\begin{verbatim}
##            40S Ribosome            60S Ribosome      Actin cytoskeleton 
##               0.4369121               0.3042575               0.3807524 
##                 Cytosol   Endoplasmic reticulum                Endosome 
##               0.6850502               0.6093775               0.4324733 
##    Extracellular matrix                Lysosome           Mitochondrion 
##               0.4261633               0.5908828               0.9491150 
##     Nucleus - Chromatin Nucleus - Non-chromatin              Peroxisome 
##               0.7944096               0.7083224               0.3140141 
...
##  [1] BiocStyle_2.7.8      gridExtra_2.3        shiny_1.0.5         
##  [4] pRolocGUI_1.13.1     rgl_0.99.9           pRolocdata_1.17.2   
##  [7] pRoloc_1.19.3        MLInterfaces_1.59.1  cluster_2.0.6       
## [10] annotate_1.57.2      XML_3.98-1.10        AnnotationDbi_1.41.4
## [13] IRanges_2.13.28      S4Vectors_0.17.37    MSnbase_2.5.10      
## [16] ProtGenerics_1.11.0  BiocParallel_1.13.1  mzR_2.13.5          
## [19] Rcpp_0.12.16         Biobase_2.39.2       BiocGenerics_0.25.3 
## [22] xtable_1.8-2         knitr_1.20          
## 
...
##  [13] rsconnect_0.8.8       viridis_0.5.0         gdata_2.18.0         
##  [16] magrittr_1.5          memoise_1.1.0         doParallel_1.0.11    
##  [19] sfsmisc_1.1-2         limma_3.35.13         recipes_0.1.2        
##  [22] gower_0.1.2           rda_1.0.2-2           dimRed_0.1.0         
##  [25] lpSolve_5.6.13        prettyunits_1.0.2     colorspace_1.3-2     
##  [28] blob_1.1.0            dplyr_0.7.4           jsonlite_1.5         
##  [31] RCurl_1.95-4.10       hexbin_1.27.2         genefilter_1.61.1    
##  [34] bindr_0.1.1           impute_1.53.0         survival_2.41-3      
##  [37] iterators_1.0.9       glue_1.2.0            DRR_0.0.3            
##  [40] gtable_0.2.0          ipred_0.9-6           zlibbioc_1.25.0      
##  [43] kernlab_0.9-25        ddalpha_1.3.1.1       prabclus_2.2-6       
##  [46] DEoptimR_1.0-8        scales_0.5.0          vsn_3.47.1           
##  [49] mvtnorm_1.0-7         DBI_0.8               viridisLite_0.3.0    
##  [52] progress_1.1.2        foreign_0.8-70        bit_1.1-12           
##  [55] proxy_0.4-21          mclust_5.4            preprocessCore_1.41.0
##  [58] DT_0.4                lava_1.6              prodlim_1.6.1        
##  [61] sampling_2.8          htmlwidgets_1.0       httr_1.3.1           
...
##  [76] munsell_0.4.3         mlbench_2.1-1         tools_3.5.0          
##  [79] RSQLite_2.0           pls_2.6-0             broom_0.4.3          
##  [82] evaluate_0.10.1       stringr_1.3.0         mzID_1.17.0          
##  [85] yaml_2.1.18           ModelMetrics_1.1.0    bit64_0.9-7          
##  [88] robustbase_0.92-8     randomForest_4.6-12   purrr_0.2.4          
##  [91] dendextend_1.7.0      bindrcpp_0.2          nlme_3.1-136         
##  [94] whisker_0.3-2         mime_0.5              RcppRoll_0.2.2       
##  [97] biomaRt_2.35.12       compiler_3.5.0        e1071_1.6-8          
## [100] affyio_1.49.1         tibble_1.4.2          stringi_1.1.7        
## [103] highr_0.6             lattice_0.20-35       trimcluster_0.1-2    
## [106] Matrix_1.2-12         psych_1.7.8           gbm_2.1.3            
## [109] pillar_1.2.1          MALDIquant_1.17       bitops_1.0-6         
## [112] httpuv_1.3.6.2        R6_2.2.2              pcaMethods_1.71.0    
## [115] affy_1.57.0           hwriter_1.3.2         codetools_0.2-15     
## [118] MASS_7.3-49           gtools_3.5.0          assertthat_0.2.0     
## [121] CVST_0.2-1            rprojroot_1.3-2       withr_2.1.2          
## [124] mnormt_1.5-5          diptest_0.75-7        grid_3.5.0           
## [127] rpart_4.1-13          timeDate_3043.102     tidyr_0.8.0          
## [130] class_7.3-14          rmarkdown_1.9         lubridate_1.7.3      
## [133] base64enc_0.1-3
\end{verbatim}
\end{kframe}
\end{knitrout}
