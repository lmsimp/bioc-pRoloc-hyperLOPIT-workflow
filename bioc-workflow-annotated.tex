...
\hl{relevent} for any quantitative spatial proteomics data,  
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{combined} \hlkwb{<-} \hlstd{MSnbase}\hlopt{::}\hlkwd{combine}\hlstd{(hyperLOPIT2015ms3r1, hyperLOPIT2015ms3r2)}
\hlstd{combined}
\end{alltt}
\begin{verbatim}
## MSnSet (storageMode: lockedEnvironment)
...
## Annotation:  
## - - - Processing information - - -
## Combined [5489,10] and [6268,10] MSnSets Tue May 22 16:06:39 2018 
...
## - - - Processing information - - -
## Combined [5489,10] and [6268,10] MSnSets Tue May 22 16:06:39 2018 
## Subset [6725,20][5032,20] Tue May 22 16:06:39 2018 
## Removed features with more than 0 NAs: Tue May 22 16:06:39 2018 
## Dropped featureData's levels Tue May 22 16:06:39 2018 
##  MSnbase version: 2.5.9
\end{verbatim}
\end{kframe}
\end{knitrout}
...
figure} \ref{fig:plotDist2}, \hl{we plot the profiles of the 
...
13S condensin complex, we \hl{would call the following code:}
...
##  Created on Tue May 22 16:06:41 2018 
##  Description:
...
\hl{The above analysis is computationally intensive and best parallelised over
...
## Annotation:  
## - - - Processing information - - -
## Added markers from  'mrk' marker vector. Tue May 22 16:06:40 2018 
## Added markers from  'pdres' marker vector. Tue May 22 16:06:42 2018 
##  MSnbase version: 2.7.1
\end{verbatim}
\begin{alltt}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# The following object is masked from 'package:MSnbase':\\\#\# \\\#\#\ \ \ \  combine}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# The following object is masked from 'package:Biobase':\\\#\# \\\#\#\ \ \ \  combine}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# The following object is masked from 'package:BiocGenerics':\\\#\# \\\#\#\ \ \ \  combine}}\end{kframe}
...
\begin{verbatim}
##            40S Ribosome            60S Ribosome      Actin cytoskeleton 
##               0.4358428               0.3026164               0.3923006 
##                 Cytosol   Endoplasmic reticulum                Endosome 
##               0.6784764               0.6086725               0.4306162 
##    Extracellular matrix                Lysosome           Mitochondrion 
##               0.4211113               0.5801971               0.9497222 
##     Nucleus - Chromatin Nucleus - Non-chromatin              Peroxisome 
##               0.7959319               0.7094645               0.3164993 
...
unsupervised clustering can be extremely difficult due to \hl{
...
##  [1] gridExtra_2.3        pRolocdata_1.19.0    pRoloc_1.21.0       
##  [4] MLInterfaces_1.61.1  cluster_2.0.7-1      annotate_1.59.0     
##  [7] XML_3.98-1.11        AnnotationDbi_1.43.1 IRanges_2.15.13     
## [10] S4Vectors_0.19.5     MSnbase_2.7.1        ProtGenerics_1.13.0 
## [13] BiocParallel_1.15.3  mzR_2.15.1           Rcpp_0.12.17        
## [16] Biobase_2.41.0       BiocGenerics_0.27.0  xtable_1.8-2        
## [19] BiocStyle_2.9.2      knitr_1.20          
## 
