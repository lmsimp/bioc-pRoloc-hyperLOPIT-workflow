...
To help examine these distributions there is also a dedicated interactive application in the `r Biocpkg("pRolocGUI")` package. To access this application:
