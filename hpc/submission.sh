...
module add R/3.3.0
module add netcdf/4.1.3 
module add gcc/4.8.1
module add rmpi/0.6-6

#! Full path to application executable: 
application="mpirun -np 1 Rscript"       # Needed to launch Rmpi

#! Run options for the application:
options="tl.R"                        # Change this to point at your R script
